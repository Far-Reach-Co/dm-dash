      ...
      modal.show(
        createElement("div", { class: "help-content" }, [
          ...
          createElement(
            "small",
            {},
            "Add images via the sidebar (GM), then click, tap, use +, or drag them onto the canvas. Pan by clicking and dragging empty space. Zoom with the scroll wheel or pinch gesture.",
          ),
          createElement("br"),
          createElement("br"),

          createElement("h2", {}, "Visibility & Permissions"),
          createElement("hr"),
          createElement("b", {}, "Standalone/User Table - Public"),
          createElement(
            "small",
            {},
            " - Anyone with the table link can open it.",
          ),
          createElement("br"),
          createElement("b", {}, "Wyrld Table - Public"),
          createElement(
            "small",
            {},
            " - Any logged-in member of that Wyrld can open it (not open internet-wide).",
          ),
          createElement("br"),
          createElement("b", {}, "Private Table"),
          createElement(
            "small",
            {},
            " - Access is limited to owner/manager/editor permissions.",
          ),
          createElement("br"),
          createElement("b", {}, "Non-manager Access"),
          createElement(
            "small",
            {},
            " - Can move/resize/rotate objects, but cannot manage settings, uploads/folders, pins, grid, or layers.",
          ),
          createElement("br"),
          createElement("br"),
          ...
          createElement(
            "small",
            {},
            " - Draw with freehand, line, rectangle, ellipse, or text tools. Set color and width.",
          ),
          createElement("br"),
          createElement("b", {}, "Zoom"),
          createElement(
            "small",
            {},
            " - Use toolbar zoom controls or mouse wheel to zoom in and out.",
          ),
          createElement("br"),
          ...
          createElement(
            "small",
            {},
            " - Anyone with the guest sandbox link can join that temporary demo session.",
          ),
          createElement("br"),
          createElement("br"),
          ...
          createElement("br"),
          createElement("b", {}, "Ctrl/Cmd + Z"),
          createElement(
            "small",
            {},
            " - While draw mode is active, undo most recent draw object",
          ),
          createElement("br"),
          createElement("br"),
