...
REMOTE_NODE_BIN="${DM_DASH_REMOTE_NODE_BIN:-/root/.nvm/versions/node/v24.13.0/bin/node}"
REMOTE_NPM_BIN="${DM_DASH_REMOTE_NPM_BIN:-/root/.nvm/versions/node/v24.13.0/bin/npm}"
REPO_URL="${DM_DASH_REPO_URL:-https://github.com/SF-Audio-Guild/dm-dash.git}"
BRANCH="${DM_DASH_BRANCH:-navel}"
REMOTE_BUILD_TS="${DM_DASH_REMOTE_BUILD_TS:-0}"
