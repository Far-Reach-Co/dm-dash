...
function addRecordImageQuery(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = {
            text: `insert into public."RecordImage" (record_id, image_id) values($1,$2) returning *`,
            values: [
                data.record_id,
                data.image_id
            ]
...
function getRecordImageQuery(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = {
            text: `select * from public."RecordImage" where id = $1`,
            values: [id]
        };
        return yield dbconfig_1.default.query(query);
    });
...
function getRecordImagesByRecordQuery(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = {
            text: `select * from public."RecordImage" where record_id = $1`,
            values: [id]
        };
        return yield dbconfig_1.default.query(query);
    });
...
function getRecordImagesByImageQuery(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = {
            text: `select * from public."RecordImage" where image_id = $1`,
            values: [id]
        };
        return yield dbconfig_1.default.query(query);
    });
...
function removeRecordImageQuery(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = {
            text: `delete from public."RecordImage" where id = $1 returning *`,
            values: [id]
        };
        return yield dbconfig_1.default.query(query);
    });
