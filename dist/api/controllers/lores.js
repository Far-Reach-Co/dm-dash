        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3: return [4, addLoreQuery(req.body)];
                case 4:
                    data = _a.sent();
...
function getLore(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var loreData, lore, projectData, project, projectUser, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
...
function removeLore(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var LoreData, Lore, projectData, project, projectUser, data, imageData, image, newCalculatedData, err_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (projectUser.rows &&
                        ...
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, removeLoreQuery(req.params.id)];
                case 5:
                    data = _a.sent();
                    res.status(204).send();
                    if (!Lore.image_id) return [3, 10];
...
function editLore(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var LoreData, Lore, projectData, project, projectUser, data, err_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 3:
                    ...
                    if (projectUser.rows &&
                        ...
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, editLoreQuery(req.params.id, req.body)];
                case 5:
                    data = _a.sent();
