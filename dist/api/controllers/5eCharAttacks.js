    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, _5eCharAttacks_1.add5eCharAttackQuery)(req.body)];
                case 1:
                    data = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, _5eCharAttacks_1.get5eCharAttacksByGeneralQuery)(req.params.general_id)];
                case 1:
                    data = _a.sent();
                    res.send(data.rows);
                    return [3, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, _5eCharAttacks_1.remove5eCharAttackQuery)(req.params.id)];
                case 1:
                    _a.sent();
                    res.status(204).send();
                    return [3, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, _5eCharAttacks_1.edit5eCharAttackQuery)(req.params.id, req.body)];
                case 1:
                    data = _a.sent();
