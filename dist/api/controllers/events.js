...
var _a = require("../queries/events.js"), addEventQuery = _a.addEventQuery, getEventsQuery = _a.getEventsQuery, getEventQuery = _a.getEventQuery, getEventsByLocationQuery = _a.getEventsByLocationQuery, getEventsByCharacterQuery = _a.getEventsByCharacterQuery, getEventsByItemQuery = _a.getEventsByItemQuery, removeEventQuery = _a.removeEventQuery, editEventQuery = _a.editEventQuery, getEventsByLoreQuery = _a.getEventsByLoreQuery;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3: return [4, addEventQuery(req.body)];
                case 4:
                    data = _a.sent();
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 3;
                case 3: return [4, getEventsQuery({
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, getEventsByLocationQuery(req.params.location_id)];
                case 5:
                    data = _a.sent();
                    res.send(data.rows);
                    return [3, 7];
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, getEventsByCharacterQuery(req.params.character_id)];
                case 5:
                    data = _a.sent();
                    res.send(data.rows);
                    return [3, 7];
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, getEventsByItemQuery(req.params.item_id)];
                case 5:
                    data = _a.sent();
                    res.send(data.rows);
                    return [3, 7];
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, getEventsByLoreQuery(req.params.lore_id)];
                case 5:
                    data = _a.sent();
                    res.send(data.rows);
                    return [3, 7];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!req.user)
                        throw { status: 401, message: "Missing Credentials" };
                    return [4, getEventQuery(req.params.id)];
                case 1:
                    noteData = _a.sent();
                ...
                case 3:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, removeEventQuery(req.params.id)];
                case 5:
                    _a.sent();
                    res.status(204).send();
                    return [3, 7];
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!projectUser)
                        throw { status: 403, message: "Forbidden" };
                    _a.label = 4;
                case 4: return [4, editEventQuery(req.params.id, req.body)];
                case 5:
                    data = _a.sent();
