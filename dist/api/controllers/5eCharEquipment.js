...
var _a = require("../queries/5eCharEquipment.js"), add5eCharEquipmentQuery = _a.add5eCharEquipmentQuery, get5eCharEquipmentQuery = _a.get5eCharEquipmentQuery, get5eCharEquipmentsByGeneralQuery = _a.get5eCharEquipmentsByGeneralQuery, remove5eCharEquipmentQuery = _a.remove5eCharEquipmentQuery, edit5eCharEquipmentQuery = _a.edit5eCharEquipmentQuery;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5: return [4, add5eCharEquipmentQuery(req.body)];
                case 6:
                    data = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3, 5];
                case 4: throw { status: 403, message: "Forbidden" };
                case 5: return [4, get5eCharEquipmentsByGeneralQuery(req.params.general_id)];
                case 6:
                    data = _a.sent();
                    res.send(data.rows);
                    return [3, 8];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!req.user)
                        throw { status: 401, message: "Missing Credentials" };
                    return [4, get5eCharEquipmentQuery(req.params.id)];
                case 1:
                ...
                case 6: return [4, remove5eCharEquipmentQuery(req.params.id)];
                case 7:
                    _a.sent();
                    res.status(204).send();
                    return [3, 9];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [3, 6];
                case 5: throw { status: 403, message: "Forbidden" };
                case 6: return [4, edit5eCharEquipmentQuery(req.params.id, req.body)];
                case 7:
                    data = _a.sent();
