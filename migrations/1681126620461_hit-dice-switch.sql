-- Up Migration
UPDATE "public"."dnd_5e_character_general" SET "hit_dice"= 0;
ALTER TABLE "public"."dnd_5e_character_general" ALTER COLUMN "hit_dice" TYPE numeric USING "hit_dice"::smallint;
...
-- Down Migration
UPDATE "public"."dnd_5e_character_general" SET "hit_dice_total"= 0;
ALTER TABLE "public"."dnd_5e_character_general" ALTER COLUMN "hit_dice_total" TYPE numeric USING "hit_dice_total"::smallint;
