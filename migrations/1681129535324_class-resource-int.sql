-- Up Migration
UPDATE "public"."dnd_5e_character_general" SET "class_resource"= 0;
ALTER TABLE "public"."dnd_5e_character_general" ALTER COLUMN "class_resource" TYPE numeric USING "class_resource"::smallint;
